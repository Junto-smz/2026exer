...
from task6_1 import DBwBubbleSort
from task6_2 import DBwSelectSort
from task6_3 import DBwInsertSort
...
if __name__ == '__main__':  # モジュールとしてインポートされるときは実行しない
    ...
    dbs = [DBwBubbleSort(),DBwSelectSort(),DBwInsertSort(),DBwHeapSort(),DBwMergeSort(),DBwQuickSort()]
